...
public class DoublyLinkList {
	 ...
	 * @return 		integer // user entered integer 
	 */
	...
	public static void main(String[] args) {
		...
		while (loopVariable == 1) {
			...
			System.out
					.println("Enter 2 insert in link list At a particular position");
			...
			case 6:
				...
				if (list.showElementAtIndex(positionToShow) == false) {
					System.out.println("sorry, Enter correct position");
				}
				break;
			case 7:
				if (list.reverse()) {
					System.out.println("link list now reversed");
				} else {
					System.out.println("sorry,link list not reversed");
				}
				break;
			default:
				loopVariable = 0;

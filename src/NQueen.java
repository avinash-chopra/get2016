 ...
 * @Date 18 july 2016 This return all the possible solution of n queen problem
 *
 */
public class NQueen {
	 ...
	 *         return 0
	 * 
	 *         This method check if a queen can be placed at this row and
	 *         column.
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		int index[] = new int[boardSize + 1];		// store index of queen for each row
		...
		for (int k = 0; k < nQueen.countNumberOfSolution; k++) {
			...
			System.out.println("total result " +nQueen.countNumberOfSolution + " this solution " + (k+1));
		}
	}

...
public class RadixSort {
	...
	public int[] countSort(int[] array, int exponent) {
		...
		// divide each array element by exponent,take its modulo by 10 to get
		// each digit and increment
		// its count by one
		...
		// start array from last and set each element to its count and decrement
		// count by 1

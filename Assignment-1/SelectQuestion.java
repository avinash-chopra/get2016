 ...
 * @Date 21 july 2016 This get the string and define type of question like
 *       single select or multi select or only text
 */
public class SelectQuestion {
	...
	String areaOfImprovement[] = new String[100]; // store are of improvement
													// field by user
	...
	/**
	 * 
	 * @param checkForQuesttion
	 *            // string to check type of question
	 * @param user
	 *            // which user inputing what
	 * @param message
	 *            // question for user
	 * @param rating

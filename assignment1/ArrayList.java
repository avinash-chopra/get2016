...
public class ArrayList<T> {
	 ...
	 *            Constructor to initialize the array list based on capacity
	 *            given by user
	 */
	 ...
	 */
	public boolean inseartAtEnd(T e) {
	 ...
	 */
	public boolean insertAtPosition(int index, T e) {
	 ...
	 */
	public boolean deleteByIndex(int location) {
	 ...
	 */
	public boolean deleteByValue(T e) {
	 ...
	 * 
	 * @param e
	 * @return the index of value given by user else throw no such element
	 *         exception
	 */
	 ...
	 */
	public boolean getElement(int location) {
	...
	public T getElementAtLocation(int location) {
	 ...
	 * @param capacity
	 * 
	 *            this method checks if the capacity is less and grows the
	 *            capacity of array
	 */
	 ...
	 * @param capacity
	 * 
	 *            this method increases the capacity of array by making a new
	 *            array with increased capacity and transferring the old array
	 *            into new one
	 */
	 ...
	 * @param c
	 * 
	 *            merge sort algorithm is implemented here the whole array is
	 *            divided here into two parts from 0 to mid and mid+1 to size
	 *            each array is sorted recursively each time and merged to
	 *            create a complete sorted array
	 */
	public void mergeSort(int low, int high, Object[] sortedArray,
			Comparator<T> c) {
	 ...
	 * @param c
	 * 
	 *            this method compares the elements of two arrays and add the
	 *            element which is smaller in original array which makes
	 *            original array sorted
	 */
	@SuppressWarnings("unchecked")
	public void merge(int low, int mid, int high, Object[] sortedArray,
			Comparator<T> c) {
		...
		while (i <= mid && j <= high) {
			...
			if (c.compare((T) sortedArray[j], (T) sortedArray[i]) > 0) {
	...
	/**
	 * @return true clears the complete array list by resetting the size to zero
	 */
